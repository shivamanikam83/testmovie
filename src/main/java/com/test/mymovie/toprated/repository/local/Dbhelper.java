...
public class Dbhelper {
    ...
    public List<MovieJson> getAllFavourite()
    {
        return Single.just(db.movieDao().getAllFavourite(true)).subscribeOn(Schedulers.io()).blockingGet();
    }

    public Single<MovieJson> getMovieDetail(int movie_id)
    {
        return Single.just(db.movieDao().getMovie(movie_id));
    }
