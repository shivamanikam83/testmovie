...
public class CustomDataSource extends PageKeyedDataSource<Integer, MovieJson> {
    ...
    @Override
    public void loadBefore(@NonNull LoadParams<Integer> params, @NonNull final LoadCallback<Integer, MovieJson> callback) {
    ...
    @Override
    public void loadAfter(@NonNull LoadParams<Integer> params, @NonNull final LoadCallback<Integer, MovieJson> callback) {
